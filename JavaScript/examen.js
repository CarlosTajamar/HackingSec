...

{
  ...
  answers: ["Sombrero amarillo", " Ciberterrorista ", "Sombrero púrpura", "Phreaking"],
  correct: 2,
  selection: null },

{
  ...
  answers: ["Malware", "Malware,Cracking", "breacher", "destroyer"],
  correct: 1,
  selection: null },
...

{
  ...
  answers: ["Crackers", "Hackers", "Holigans", "Loovers"],
  correct: 0,
  selection: null },

{
  ...
  answers: ["El auditor de seguridad informática", " El usuario", "El programador", "Ninguna de las anteriores"],
  correct: 1,
  selection: null },

{
  ...
  answers: ["La ingeniería de sistemas", "La legislación informática", "La seguridad infomática", "Ninguna de las anteriores"],
  correct: 2,
  selection: null },

{
  ...
  answers: ["La red", "El ordenador", "El hardware y software", "Los datos"],
  correct: 3,
  selection: null },

{
  ...
  answers: ["Empaquetamiento", "Protección", "Firewall", " Encriptado"],
  correct: 3,
  selection: null },
