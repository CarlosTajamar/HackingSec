function newuser(form) {
	...
	if(form.code.value == registercode[0]) {
		...
		alert("Nombre de usuario - 'miembros', contraseña - 'members'")/* Member username and password*/
	}
	else {
		alert("Código incorrecto. Vuelva a intentarlo o póngase en contacto con Michael para obtener ayuda.")/* No such user */
	}
}